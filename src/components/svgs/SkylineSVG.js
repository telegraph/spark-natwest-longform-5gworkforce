...
export default function SkylineSVG() {
  ...
  return (
    <svg ref={skyline} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
    id="Layer_1" data-name="Layer 1" viewBox="0 0 1920 1080.42">
        <defs>
        ...
        <g id="Layer_3" data-name="Layer 3">
            ...
            />
            <g id="car3" ref={car3}>
                <polygon fill="#576daf" points="1415.24 693.71 1426.15 687.02 1415.61 685.71 1415.24 693.71"
                />
                <polygon fill="#576daf" points="1461.7 720.58 1472.61 713.88 1462.07 712.57 1461.7 720.58"
                />
                <path fill="#00adb9" d="M1429.4 707.9l4.1-2.4c1.4-.8 2.3-2.4 2.3-4.8a16.4 16.4 0 0 0-7.5-13c-2-1.1-4-1.2-5.3-.4l-4.4 2.5z"
                />
                <path fill="#42145f" d="M1424 690.3a16.4 16.4 0 0 1 7.4 12.9c0 4.7-3.3 6.6-7.5 4.2a16.4 16.4 0 0 1-7.4-12.9c0-4.7 3.4-6.6 7.5-4.2z"
                />
                <path fill="#f5f3f7" d="M1427.3 705.9a4.2 4.2 0 0 1-2-.7 13.8 13.8 0 0 1-6.2-10.7c0-2.3 1-2.7 1.6-2.7a4.2 4.2 0 0 1 2 .7 13.8 13.8 0 0 1 6.2 10.7c0 2.3-1 2.7-1.6 2.7z"
                />
                <path fill="#788abf" d="M1525.8 716v-8.3s-1.1-7.4-13-20.6l-18-20.7a41 41 0 0 0-9.6-8.2l-20-10.4a15.2 15.2 0 0 0-14.7.4l-28.9 17 74.2 71z"
                />
                <path fill="#576daf" d="M1524.9 704.9a14.7 14.7 0 0 1 .9 2.9v8.3l-30 20.2-6.9-6.8z"
                />
                <path fill="#fff" d="M1501.9 720.6l-4.7 3.2c-3.3-.5-9-2.6-10.7-5.5l-3.2-5.7s13.7.6 18.6 8z"
                />
                <path fill="url(#linear-gradient-s-4)" d="M1460.1 683.7l32-20.2a1280.8 1280.8 0 0 0 20.8 23.6l-36.7 23.6s-11.3-27.5-16-27z"
                />
                <path fill="#00adb9" d="M1475.8 734.3l4.2-2.3c1.4-.8 2.3-2.5 2.3-4.9a16.4 16.4 0 0 0-7.5-12.9c-2-1.2-4-1.3-5.3-.5l-4.4 2.5z"
                />
                <path fill="#42145f" d="M1470.5 716.7a16.4 16.4 0 0 1 7.4 13c0 4.6-3.3 6.6-7.5 4.2a16.4 16.4 0 0 1-7.4-12.9c0-4.7 3.4-6.6 7.5-4.3z"
                />
                <path fill="#f5f3f7" d="M1473.8 732.4a4.2 4.2 0 0 1-2-.7 13.8 13.8 0 0 1-6.2-10.7c0-2.4 1-2.7 1.5-2.7a4.2 4.2 0 0 1 2.1.6 13.8 13.8 0 0 1 6.2 10.7c0 2.4-1 2.8-1.6 2.8z"
                />
                <path fill="#00adb9" d="M1458.5 679.4c10.5 6.3 28 33.7 35.2 47.7a19 19 0 0 1 2.1 9.1 11 11 0 0 1-8.8-1l-7.8-4.5a9.4 9.4 0 0 0 0-1 17.6 17.6 0 0 0-8-14 8.2 8.2 0 0 0-4-1.3c-3.2 0-5.3 2.5-5.5 6.2l-29-16.7v-.7a17.6 17.6 0 0 0-8-14 8.2 8.2 0 0 0-4-1.2c-3 0-5.2 2.3-5.5 5.8l-2.6-1.5v-17.9l5.7-6.6a12.5 12.5 0 0 1 15.5-2.8 761 761 0 0 1 24.7 14.4z"
                />
                <path fill="url(#linear-gradient-s-5)" d="M1432.9 666.7c6.7 3.7 15 8.5 24.6 14.3a79.2 79.2 0 0 1 18.2 20.4l5 7.4-63.6-36.6 2.7-3.1a10.6 10.6 0 0 1 13.1-2.4z"
                />
                <path fill="#fff" d="M1522.2 706.6s-4.6-5-5.7-15.5a50.7 50.7 0 0 1 8.4 13.8z"
                />
                <rect width="1" height="19.37" x="1451.27" y="677.16" fill="#00adb9" />
                <rect width="1" height="19.51" x="1427.47" y="663.54" fill="#00adb9" />
            </g>
