    ...
    <>
      ...
      <Pagebody>
        <AnimationTrigger>
          <p>
            <Dropcap>T</Dropcap>
            he way we work is changing: people no longer expect to work from
            nine to five, or spend four decades in the same job before
            retiring at 65. In response to these cultural and social shifts,
            businesses will need to demonstrate agility and adapt in order to
            thrive.
          </p>
          <p>
            Unemployment sits at a 44-year-low in Britain today and the
            freelance economy is booming, having grown 25pc since the financial
            crisis, according to IPSE, the Association of Independent
            Professionals and the Self-Employed. Among millennials in
            particular, job hopping is a way of life, with research from
            Deloitte finding that 21pc of millennial workers have moved job
            within the past year.
          </p>
          <p>
            And thanks in part to changes in pension rules, people are working
            later in life. In fact, the average career exit age for men now is
            over 65. This means that workplaces are seeing five generations of
            employees all working together – the so-called “5G workforce”.
          </p>
        </AnimationTrigger>
      </Pagebody>
      <Timeline
